...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, title: string, videoId: string, teacher?: { __typename?: 'Teacher', bio: string, name: string, avatarURL: string } | null } | null };
